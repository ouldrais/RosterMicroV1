...
import { ResourceService } from 'app/entities/RosterMicroV1/resource/service/resource.service';
...
describe('ResourcePlan Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Resource query and add missing value', () => {
      ...
      const resource: IResource = { id: 13797 };
      resourcePlan.resource = resource;

      const resourceCollection: IResource[] = [{ id: 2691 }];
    ...
    it('Should call Shift query and add missing value', () => {
      const resourcePlan: IResourcePlan = { id: 456 };
      const shift: IShift = { id: 7037 };
      resourcePlan.shift = shift;

      const shiftCollection: IShift[] = [{ id: 16481 }];
    ...
    it('Should call Position query and add missing value', () => {
      const resourcePlan: IResourcePlan = { id: 456 };
      const position: IPosition = { id: 30053 };
      resourcePlan.position = position;

      const positionCollection: IPosition[] = [{ id: 28011 }];
    ...
    it('Should update editForm', () => {
      const resourcePlan: IResourcePlan = { id: 456 };
      const resource: IResource = { id: 31063 };
      resourcePlan.resource = resource;
      const shift: IShift = { id: 2289 };
      resourcePlan.shift = shift;
      const position: IPosition = { id: 30711 };
      resourcePlan.position = position;
