...
import { ShiftTypeService } from 'app/entities/RosterMicroV1/shift-type/service/shift-type.service';
...
describe('RefRotation Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ShiftType query and add missing value', () => {
      ...
      const shiftType: IShiftType = { id: 4527 };
      refRotation.shiftType = shiftType;

      const shiftTypeCollection: IShiftType[] = [{ id: 19251 }];
    ...
    it('Should update editForm', () => {
      const refRotation: IRefRotation = { id: 456 };
      const shiftType: IShiftType = { id: 14134 };
      refRotation.shiftType = shiftType;
