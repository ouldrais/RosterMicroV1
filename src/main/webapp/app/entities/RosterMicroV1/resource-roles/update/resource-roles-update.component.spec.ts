...
import { RoleService } from 'app/entities/RosterMicroV1/role/service/role.service';
...
describe('ResourceRoles Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Role query and add missing value', () => {
      ...
      const role: IRole = { id: 14028 };
      resourceRoles.role = role;

      const roleCollection: IRole[] = [{ id: 30182 }];
    ...
    it('Should call Resource query and add missing value', () => {
      const resourceRoles: IResourceRoles = { id: 456 };
      const resource: IResource = { id: 23508 };
      resourceRoles.resource = resource;

      const resourceCollection: IResource[] = [{ id: 17552 }];
    ...
    it('Should update editForm', () => {
      const resourceRoles: IResourceRoles = { id: 456 };
      const role: IRole = { id: 1810 };
      resourceRoles.role = role;
      const resource: IResource = { id: 12758 };
      resourceRoles.resource = resource;
