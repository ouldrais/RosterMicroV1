...
import { FacilityService } from 'app/entities/RosterMicroV1/facility/service/facility.service';
...
describe('Department Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Facility query and add missing value', () => {
      ...
      const facility: IFacility = { id: 25622 };
      department.facility = facility;

      const facilityCollection: IFacility[] = [{ id: 6849 }];
    ...
    it('Should update editForm', () => {
      const department: IDepartment = { id: 456 };
      const facility: IFacility = { id: 27501 };
      department.facility = facility;
