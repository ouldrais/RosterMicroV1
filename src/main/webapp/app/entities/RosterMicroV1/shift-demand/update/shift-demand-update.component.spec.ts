...
import { ShiftService } from 'app/entities/RosterMicroV1/shift/service/shift.service';
import { ITask } from 'app/entities/RosterMicroV1/task/task.model';
import { TaskService } from 'app/entities/RosterMicroV1/task/service/task.service';
import { IPosition } from 'app/entities/RosterMicroV1/position/position.model';
import { PositionService } from 'app/entities/RosterMicroV1/position/service/position.service';
import { IDepartment } from 'app/entities/RosterMicroV1/department/department.model';
import { DepartmentService } from 'app/entities/RosterMicroV1/department/service/department.service';
...
describe('ShiftDemand Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Shift query and add missing value', () => {
      ...
      const shift: IShift = { id: 20614 };
      shiftDemand.shift = shift;

      const shiftCollection: IShift[] = [{ id: 15949 }];
    ...
    it('Should call Task query and add missing value', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const task: ITask = { id: 19922 };
      shiftDemand.task = task;

      const taskCollection: ITask[] = [{ id: 18100 }];
    ...
    it('Should call Position query and add missing value', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const position: IPosition = { id: 2779 };
      shiftDemand.position = position;

      const positionCollection: IPosition[] = [{ id: 4989 }];
    ...
    it('Should call Department query and add missing value', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const department: IDepartment = { id: 11411 };
      shiftDemand.department = department;

      const departmentCollection: IDepartment[] = [{ id: 10059 }];
    ...
    it('Should update editForm', () => {
      const shiftDemand: IShiftDemand = { id: 456 };
      const shift: IShift = { id: 19883 };
      shiftDemand.shift = shift;
      const task: ITask = { id: 5430 };
      shiftDemand.task = task;
      const position: IPosition = { id: 29054 };
      shiftDemand.position = position;
      const department: IDepartment = { id: 28128 };
      shiftDemand.department = department;
