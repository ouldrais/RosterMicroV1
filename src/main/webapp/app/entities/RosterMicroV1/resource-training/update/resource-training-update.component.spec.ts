...
import { TrainingService } from 'app/entities/RosterMicroV1/training/service/training.service';
...
describe('ResourceTraining Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Resource query and add missing value', () => {
      ...
      const resource: IResource = { id: 7766 };
      resourceTraining.resource = resource;

      const resourceCollection: IResource[] = [{ id: 7734 }];
    ...
    it('Should call Training query and add missing value', () => {
      const resourceTraining: IResourceTraining = { id: 456 };
      const training: ITraining = { id: 28323 };
      resourceTraining.training = training;

      const trainingCollection: ITraining[] = [{ id: 30005 }];
    ...
    it('Should update editForm', () => {
      const resourceTraining: IResourceTraining = { id: 456 };
      const resource: IResource = { id: 27959 };
      resourceTraining.resource = resource;
      const training: ITraining = { id: 10374 };
      resourceTraining.training = training;
