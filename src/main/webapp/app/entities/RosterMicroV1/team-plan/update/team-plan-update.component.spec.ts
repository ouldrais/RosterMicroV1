...
import { TeamService } from 'app/entities/RosterMicroV1/team/service/team.service';
...
describe('TeamPlan Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Team query and add missing value', () => {
      ...
      const team: ITeam = { id: 26322 };
      teamPlan.team = team;

      const teamCollection: ITeam[] = [{ id: 21826 }];
    ...
    it('Should call Shift query and add missing value', () => {
      const teamPlan: ITeamPlan = { id: 456 };
      const shift: IShift = { id: 13388 };
      teamPlan.shift = shift;

      const shiftCollection: IShift[] = [{ id: 17612 }];
    ...
    it('Should update editForm', () => {
      const teamPlan: ITeamPlan = { id: 456 };
      const team: ITeam = { id: 10195 };
      teamPlan.team = team;
      const shift: IShift = { id: 17152 };
      teamPlan.shift = shift;
